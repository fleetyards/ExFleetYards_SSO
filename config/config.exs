...
config :ex_fleet_yards_sso_web,
  ...
  ecto_repos: [ExFleetYardsSSO.Repo],
  generators: [context_app: :ex_fleet_yards_sso]

# Configures the endpoint
config :ex_fleet_yards_sso_web, ExFleetYardsSSOWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: ExFleetYardsSSOWeb.ErrorHTML, json: ExFleetYardsSSOWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: ExFleetYardsSSO.PubSub,
  live_view: [signing_salt: "Ax6YtMRs"]
...
config :esbuild,
  ...
  default: [
    ...
    cd: Path.expand("../apps/ex_fleet_yards_sso_web/assets", __DIR__),
